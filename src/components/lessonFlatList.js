...
import { View, Text, Image, StyleSheet, TouchableOpacity, ScrollView, Platform, FlatList, RefreshControl } from 'react-native';
...
export default class LessonFlatItem extends React.PureComponent {
    ...
    _renderItem = ({ item }) => (
        <TouchableOpacity
            activeOpacity={1}
            onPress={() => this.props.onItemClick(item.href)}
    ...
    _keyExtractor = (item, index) => item.href;
